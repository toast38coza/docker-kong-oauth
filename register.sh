...
curl http://docker.local:8000/oauth2/authorize \
    ...
    --data "client_id=b4b123e18f3349e6bc7172a656692612" --data "response_type=code" --data "provision_key=c776b1cdd4974e85a7fc8e1390ce7769" --data "authenticated_userid=user123"
