...
curl http://docker.local:8000/oauth2/token -H "x-forwarded-proto: https" -d "grant_type=authorization_code"  -d "client_id=3e5d464b8b164b76a5ac7efd4ff61362" -d "client_secret=6f7b4f9015084acd923e31b324a283b8"  -d "code=711e9843e67f4507afed990561cf608e" 
...
curl -i -X GET \
  --url http://docker.local:8000?access_token=6c65920417e6417cb4af1ed57adb1a59 \
  --header 'Host: service1.com' 

curl -i -X GET \
  --url http://docker.local:8000/service2?access_token=6c65920417e6417cb4af1ed57adb1a59 \
  --header 'Host: service1.com' 
